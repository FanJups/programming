...
arrondi entier supérieur Math.ceil()
...
# create-setup-and-deploy-your-own-cloud-web-server
...
https://www.javaguides.net/2018/09/spring-boot-spring-mvc-role-based-spring-security-jpa-thymeleaf-mysql-tutorial.html?spref=fb&m=1

# spring boot data jpa project example
...
# Angular 8 spring boot real  project example
