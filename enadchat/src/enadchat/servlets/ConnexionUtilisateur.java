...
import enadchat.forms.ConnexionUtilisateurForm;

public class ConnexionUtilisateur extends HttpServlet {

	public static final String VUE_ICU = "/WEB-INF/connexionUtilisateur.jsp";
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ConnexionUtilisateurForm form = new ConnexionUtilisateurForm(utilisateurDao);
