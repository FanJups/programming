...
public class NoobChain {
	...
	public static void main(String[] args) {
		...
		blockchain.add(new Block(new Animal("lémurien", "primate", "nord ouest madagascar", "masculin"), "0"));
		System.out.println("Trying to Mine block 1... ");
		blockchain.get(0).mineBlock(difficulty);

		blockchain.add(new Block(new Animal("dauphin", "mammifère", "canal du mozambique", "féminin"),
				blockchain.get(blockchain.size() - 1).hash));
		System.out.println("Trying to Mine block 2... ");
		blockchain.get(1).mineBlock(difficulty);

		blockchain.add(new Block(new Animal("ankoay", "rapace", "nord ouest madagascar", "masculin"),
				blockchain.get(blockchain.size() - 1).hash));
